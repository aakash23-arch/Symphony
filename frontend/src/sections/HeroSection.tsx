  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1500px] mx-auto w-full px-4 sm:px-8 relative z-10">
        ...
        {/* Bottom Stat Ribbon */}
        <div className="mt-14 sm:mt-20 pt-6 border-t border-border flex flex-wrap items-center justify-between gap-4">
          <p className="font-mono text-sm sm:text-base text-fg font-bold">
            A cloned voice fools the human ear in under 3 seconds.
          </p>
          <p className="font-mono text-micro-label uppercase text-fg-tertiary">
            SYMPHONY CATCHES IT BEFORE THE MONEY MOVES
          </p>
        </div>
      </div>
    </section>
